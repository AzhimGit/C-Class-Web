...
<div class="p-4 md:p-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        ...
        <a href="{{ route('dashboard.gallery') }}" class="group bg-gray-700/60 p-5 rounded-xl border border-gray-600 hover:border-emerald-500/50 hover:bg-gray-700 transition">
            <div class="flex items-start gap-4">
